...
<script>
  export default {
    ...
    methods: {
      ...
      // getDictByDesc(desc){
      //   var _this = this;
      //   this.getRequest("/dict/getDictByDesc?desc="+desc).then(resp=> {
      //     if (resp ) {
      //       _this.awardType = resp.data;
      //       console.log(_this.awardType);
      //     }
      //   })
      // }
    },
    mounted: function () {
      this.loadAwardsCfg();
      //获取字典奖罚类别
     // this.getDictByDesc("奖罚类型");
     // console.log(this.$store.getters.getDictByDesc("奖罚类型"));
    },
    filters: {
