<template>
  <div style="margin-top: 10px">
    <el-table :data="emps" size="mini" border stripe v-loading="tableLoading" style="width: 100%">
      ...
      <el-table-column prop="name" align="left" fixed label="姓名" width="120"></el-table-column>
      <el-table-column prop="workID" width="120" align="left" label="工号"></el-table-column>
      <el-table-column prop="email" width="200" align="left" label="电子邮件"></el-table-column>
      <el-table-column prop="phone" width="120" label="电话号码"></el-table-column>
      <el-table-column prop="department.name" align="left" width="120" label="所属部门"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    loadEmps() {
      ...
      var _this = this;
      this.getRequest(
        "/salary/sobcfg/emp?page=" + this.currentPage + "&size=10"
      ).then(resp => {
